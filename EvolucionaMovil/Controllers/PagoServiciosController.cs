    ...
    public class PagoServiciosController : CustomControllerBase
    {
        ...
        public ActionResult Create()
        {
            ...
            if (paycenter != null)
            {
                ...
                ViewBag.Mensaje = "El usuario no tiene un paycenter relacionado válido";
        ...
        public ActionResult Create(PagoVM model)
        {
            ...
            if (paycenter != null)
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    {
                        ViewBag.Mensaje = "Ocurrio un error al registrar el pago: " + e.Message;
                    }
                }
                else
                    ViewBag.Mensaje = "Los datos no son válidos";
            }
            else
                ViewBag.Mensaje = "El usuario no tiene un paycenter relacionado válido";
        ...
        public ViewResult Ticket(int id)
        {
            ...
            {               
                ...
                {
                    ViewBag.Mensaje = "Ocurrio un error al cargar el ticket: " + e.Message;
                }
            }
            else
            {
        ...
        private PagoVM FillPagoVM(Int32 id)
        {
            ...
            {
                ViewBag.Mensaje = "Ocurrio un error al recuperar la información del pago: " + e.Message;
            }
            return pagoVM;
        }
